<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page errorPage = "error_handle2.jsp" %> 
<!DOCTYPE html>
<html>
<head>
...
<%
        ...
        if (responseCheck != null ) {
                 ...
                 response.setHeader("Location", "redirect2.jsp?office=" + responseCheck);
        }
...
<%
   ...
   pageContext.setAttribute("userid", "Harni");
   out.println("userId attribute from pageContext: " + pageContext.getAttribute("userid") + "<br>");    
%>
<a href="index2.jsp?office=head_office">Show usage of response object</a><br>
<a href="index2.jsp?error=1">Show usage of error  object</a><br>
